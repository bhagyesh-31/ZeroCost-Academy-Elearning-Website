...
<head>
    <meta charset="utf-8">
    <title>ZeroCost Academy : Contact</title>
            ...
            <div class="row g-4">
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-3">
                            <h5>Office</h5>
                            <p class="mb-0">402107 Raigad,Lonere,Maharashtra</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary w-100 py-3" type="submit"><a
                                        href="mailto:lahaneshriram2@gail.com" class="text-decoration-none"
