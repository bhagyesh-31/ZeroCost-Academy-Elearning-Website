...
<head>
    <meta charset="utf-8">
    <title>ZeroCost Academy : Testimonial</title>
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="text-center">
                <h1 class=" bg-white text-center px-3" style="color: #fb873f;">Successful stories</h1>
                <p class="mb-5">Can ZeroCost Academy courses help your career? Our learners tell us how.</p>
            </div>
            <div class="owl-carousel testimonial-carousel position-relative">
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src="img/sara%20k.jpeg"
                        style="width: 80px; height: 80px;">
                    <h5 class="mb-0">Sara K.</h5>
                    <div class="testimonial-text bg-light text-center p-4">
                        <p class="mb-0">I stumbled upon ZeroCost Academy while searching for free courses. The quality
                ...
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src="img/john%20m.jpeg"
                        style="width: 80px; height: 80px;">
                ...
                <div class="testimonial-item text-center">
                    <img class="border rounded-circle p-2 mx-auto mb-3" src="img/Lisa%20s..jpeg"
                        style="width: 80px; height: 80px;">
