...
<head>
    <meta charset="utf-8">
    <title>ZeroCost Academy : About Us</title>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4" style="color: #fb873f;">Welcome to ZeroCost Academy</h1>
                    <p class="mb-4">
                        At ZeroCost Academy, we believe in accessible, innovative learning experiences that adapt to your
                    ...
                    <p class="mb-4">Welcome to ZeroCost Academy, where learning knows no boundaries. Our mission
                        is to empower individuals worldwide through accessible and innovative education. Here's what
                        sets us apart:</p>

                    <h3 class="mb-4">Our Vision</h3>
                    <p class="mb-4">At ZeroCost Academy, we envision a world where learning is accessible to everyone,
                    ...
                    <p class="mb-4">We believe in the transformative power of education. ZeroCost Academy is
                    ...
                    <p class="mb-4"> ZeroCost Academy is more than just courses; it's a vibrant community. We
                    ...
                    <p class=" mt-5 mb-4">Thank you! for being a part of ZeroCost Academy. Together, let's embark on a
